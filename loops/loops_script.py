...
while(isClosed == False):
    ...
    for key in products.keys():                         # pętla wypisująca zawartość słownika products
    ...
    if(decision == 0):                                  # wyjście z programu
        ...
        if(products[decision][2] < amount):             # porównanie ilości z magazynem -> za dużo jest zamawiane
            ...
            order[decision] = [products[decision][0],products[decision][1],amount] # dodanie zamówienia do koszyka
            print("Twój koszyk")
